...
Additionally, it is designed to be relatively simple to use, with relatively
few advanced features and logical constructs.
...
Advocation for such a requirement and its enforcement is another area with
potential.
