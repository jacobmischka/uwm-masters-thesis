...
Isabelle/HOL\cite{IsabelleOverview}, and SASyLF\cite{SASyLF}.
...
Due to the way in which Isabelle enumerates automatically-generated cases and rules
when performing proofs, many of the modifications were straightforward adjustments
of numeric indices: changing rule 14 to rule 15 to account for the newly added
rule 12, for example.
