...
At a high level, \texttt{convert\_sat} behaves identically to the existing
\texttt{convert}, it simply fails in fewer cases.
...
of numeric indeces: changing rule 14 to rule 15 to account for the newly added
rule 12, for example.
...
application defintion was created for each integer type.
...
The intrepreter additionally required one new lemma stating
